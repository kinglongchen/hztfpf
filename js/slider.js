...
function nextStep(step,fun) {
		if(this.n_value>=this.n_maxValue) return true
		this.f_setValue(this.n_value+(step?step:2400),1)
		fun()
		return false
...
function f_sliderMouseUp (e_event, b_watching) {
	...
	if (window.n_activeSliderId != null) {
		...
		if (o_slider.sliderStop) o_slider.sliderStop()
