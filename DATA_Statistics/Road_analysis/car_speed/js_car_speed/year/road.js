...
function data_update(data,road_name) {
	...
	$('#chart_container').highcharts().setTitle({text:road_name+'行程车速年变化情况'})
...
function data_req(year,month,day,road_id,road_name) {
	...
	req_data = {year:year,id:road_id,din:'cs',qrytype:'road',timetype:'year'};
