...
<script src="js_traf_flow/year/road.js"></script>
<style>
.choose{
	margin:0 0 0 20px;
	padding:5px 0 5px 0;
        ...
        <div style="clear:both"></div> 
            <div style="width:96.2%;margin:10px 0 0 20px;">
                <table class="tab1">
                      <tr>
                      <th scope="col">
                      		<div>最高值:<span id='max_val' class="red">Loading...</span><span style="margin-left:20px">最高值对应时间:<span id='time' class="red">Loading...</span></div>
                      </th>
                      <th scope="col">
...
<div style="float:left;width:300px;margin:10px 0 0 0;">
    <div class="tb1">关联时段分析</div>
    	<div class="glfx">
               <table class="tqjz">
                  <th class="h">注意：本数据是近五年内相关数据对比结果</th>
                  <tr class="t1">
                    <th scope="col">
                        历史同期均值
                    </th>
                  ...
                  <th class="h">注意：本数据是近两年内相关数据对比结果</th>
                  <tr class="t1">
                    <th>前一年均值</th>
                    <th>
