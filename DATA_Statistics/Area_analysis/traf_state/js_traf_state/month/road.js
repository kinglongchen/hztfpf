    ...
    $('#chart_crowd_num').highcharts({
        ...
        series: [{
            ...
            data: [
                ...
                0.6802, 0.678, 0.6796, 0.6817, 0.6832, 0.6877, 0.6912, 0.6914, 0.7009, 0.6843, 
				0.6846, 0.7153, 0.7156, 0.7158,0.714, 0.7119, 0.7129, 0.7129, 0.7049, 0.7095
			]
        }]
    });
});				
...
$(function () {
    $('#chart_car_speed').highcharts({
        ...
        series: [{
            name: '车速',
            data: [2.4, 2.8, 3.1, 2.9, 2.2, 3.9, 4, 12.5, 28,17.3,
			 12.8, 18, 14.7, 14.5, 13.3, 12.8, 12.4, 21.8, 21.7, 11.2,
			 5.5,4.5,4,3.6,3.9,8.8,7.6,4,5,7],
            dataLabels: {
                enabled: false,
                rotation: -90,
                color: '#f00',
