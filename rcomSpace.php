...
<script type="text/javascript" >
   ...
   <p style="font:20px 微软雅黑, Verdana, sans-serif; text-align:center;">路段空间对比分析</p>
   <!--------------------------右侧----------------------------------->
    <div id="chart1" >
    	<div id="chooseBar">
             <form action="chart_QRY.php" method="get"  >
                ...
                <script type="text/javascript">
                   ...
                   <select id="roadSel1"class="dropdown" tabindex="8" style="position:relative; float:left;" data-settings='{"wrapperClass":"metro"}'>
                   ...
                   <select id="roadSel2"class="dropdown" tabindex="8" style="position:relative; float:left;" data-settings='{"wrapperClass":"metro"}'>
                      <option value="">选择路段2</option>
                      <option value="1">文一西路-狮山路-绿汀路</option>
                      <option value="2">环城北路-环城东路-建国北路</option>
                      <option value="3">庆春路-环城西路-延安路</option>
                      <option value="4">莫干山路-天目山路-文晖路</option>
