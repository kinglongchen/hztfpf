...
<div style="margin:0 0 20px 0;">
    ...
    <table border="1" style="float:left; border-collapse:collapse;table-layout:fixed">
      <caption>
        常发拥堵路段分析
      </caption>
      <tr>
        <th scope="col" style="width:38%">分类</th>
        <th scope="col" style="width:60%">分析</th>
      </tr>
      <tr>
        <th scope="row">日常发拥堵路段</th>
        <td>
            <div id="day_cons_bar"></div>
        </td>
      </tr>
      <tr>
        <th scope="row">月常发拥堵路段</th>
        <td>
            <div id="month_cons_bar"></div>
        </td>
      </tr>
      <tr>
        <th scope="row">年常发拥堵路段</th>
        <td>
            <div id="year_cons_bar"></div>
        </td>
      </tr>
    </table>
    </div>
