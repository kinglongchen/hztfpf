...
<script type="text/javascript" >
  ...
  <div id="infobg">
   <p style="font:20px 微软雅黑, Verdana, sans-serif; text-align:center;">区域拥堵指数分析</p>
   <!--------------------------右侧----------------------------------->
    <div id="chart1" >
    	<div id="chooseBar">
             <form action="chart_QRY.php" method="get"  >
             	<h style="position:relative; float:left;margin:6px 0 0 30px;">起始时间</h>
                <input type="text" id="staTime" value="" style="position:relative; float:left;margin:5px 0 0 10px;">
                
                <script type="text/javascript">
                    $(function(){
                        $('#staTime').appendDtpicker({"locale": "cn"});
					});
                    
                </script>
                <h style="position:relative; float:left;margin:6px 0 0 10px;">结束时间</h>
                 <input type="text" id="endTime" value="" style="position:relative; float:left;margin:5px 0 0 10px;">
                <script type="text/javascript">
                    $(function(){
                        $('#endTime').appendDtpicker({"locale": "cn"});
                    });
                </script>
               ...
               <select id="roadSel"class="dropdown" tabindex="8" style="position:relative; float:left;" data-settings='{"wrapperClass":"metro"}'>
                  ...
                  <select id="areaSel"class="dropdown" tabindex="8" data-settings='{"wrapperClass":"metro"}'  style="display: ">
                  ...
                  <input id="QUERY" style="position:relative; float:left;margin:5px 0 0 10px;" type="button"  value="查询" />          
             </form>
     </div>
