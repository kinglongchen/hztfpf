...
<script type="text/javascript" >
  ...
  <div id="infobg">
     <p style="font:20px 微软雅黑, Verdana, sans-serif; text-align:center;">区域同期对比分析</p>
   <!--------------------------右侧----------------------------------->
    <div id="chart1" >
    	<div id="chooseBar">
             <form action="chart_QRY.php" method="get"  >
             	<h style="position:relative; float:left;margin:6px 0 0 30px;">日期1</h>
                ...
                <script type="text/javascript">
                  ...
                  <input id="QUERY_Time_Compare" style="position:relative; float:left;margin:5px 0 0 10px;" type="button"  value="查询" />          
             </form>
     </div>
